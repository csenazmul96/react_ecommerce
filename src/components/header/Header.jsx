...
const Header = ({customerDetails,cartItems, sendCustomerDetaisRequest, GetCart}) =>{
                            ...
                            <div className="header_cart">
                                <ul>
                                    ...
                                    <li className="profile_ic"><a href="#">
                                        ...
                                        MY BAG <span>{cartItems ? cartItems.length : 0}</span> </a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
export default connect(mapStateToProps, {sendCustomerDetaisRequest, GetCart})(Header)
